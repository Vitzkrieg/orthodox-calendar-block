...
function initOrthodoxCalendar(ocEl) {
  ...
  function ocSetElHtml(ocEl, content) {
    ocEl.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_0__["default"].sanitize(content);
  }
  ...
  async function loadCalendar2(infoEl, mm, dd, yy, dt, hh, ll, tt, ss) {
    ...
    fetch(par, {
      ...
      if (response?.success) {
        ...
        ocSetElHtml(infoEl, '<p>An error occurred fetching the calendar information. Please visit <a href="http://www.holytrinityorthodox.com/">holytrinityorthodox.com/calendar</a> to see information.');
        ocLoading = false;
      }
